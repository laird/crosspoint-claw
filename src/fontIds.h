...
#define PULSR_10_FONT_ID (1256758731)
#define PULSR_12_FONT_ID (988272587)
#define ANTONIO_12_FONT_ID (-965283929)
#define ANTONIO_14_FONT_ID (-1594201911)
#define ANTONIO_16_FONT_ID (419627196)
#define ANTONIO_18_FONT_ID (1392258824)
