...
inline std::vector<SettingInfo> getSettingsList() {
  std::vector<SettingInfo> list = {
      ...
      SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme,
                        {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED, StrId::STR_THEME_PULSR, StrId::STR_THEME_DARK_PULSR}, "uiTheme",
                        StrId::STR_CAT_DISPLAY),
      ...
      SettingInfo::Enum(StrId::STR_FONT_FAMILY, &CrossPointSettings::fontFamily,
                        {StrId::STR_BOOKERLY, StrId::STR_NOTO_SANS, StrId::STR_OPEN_DYSLEXIC, StrId::STR_ANTONIO}, "fontFamily",
